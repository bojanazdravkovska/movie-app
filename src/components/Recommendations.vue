...
<template>
    <div>
      ...
      <input v-model="searchQuery" class="text-red-600" placeholder="Enter a movie title" />
      ...
      <div v-if="searchResults.length">
        ...
        <ul>
          <li v-for="movie in searchResults" :key="movie.id">
            {{ movie.title }}
            <button @click="getRecommendations(movie.id)">Get Recommendations</button>
